...
export class PagesRepository extends Repository {
   ...
   * Format row GA4 data
   */
  private static format(reports: AnalyticsPayload, websiteUrl: string, pagesPathListToExclude?: Array<string>): Array<Page> {
  ...
  private static filterPages(allPages: Array<AnalyticDataRows>, pagesPathListToExclude: Array<string>) {
