...
describe('parseRange utility', () => {
  ...
  it('should correctly return range for day with no arguments', () => {
    expect(JSON.stringify(parseRange())).toEqual(
      JSON.stringify({
        range: 'day',
        originalRange: {
          startDate: '1daysAgo',
  ...
  it('should correctly return range for day with day arg', () => {
    expect(JSON.stringify(parseRange(RangeType.day))).toEqual(
      JSON.stringify({
        range: 'day',
        originalRange: {
          startDate: '1daysAgo',
  ...
  it('should correctly return range for week with week arg', () => {
    expect(JSON.stringify(parseRange(RangeType.week))).toEqual(
      JSON.stringify({
        range: 'week',
        originalRange: {
          startDate: '7daysAgo',
  ...
  it('should correctly return range for month with month arg', () => {
    expect(JSON.stringify(parseRange(RangeType.month))).toEqual(
      JSON.stringify({
        range: 'month',
        originalRange: {
          startDate: '30daysAgo',
