...
export const defaultConfig: RadiatorConfig = {
  env: {
    ...
    analyticsClientCertUrl:
      'https://www.googleapis.com/robot/v1/metadata/x509/radiator%40analytics-radiator.iam.gserviceaccount.com',
    slackWebhookUrl:
      'https://hooks.slack.com/services/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',
